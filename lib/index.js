...
console.log(
  chalk.whiteBright(" Version: ") + chalk.greenBright("v2.1")
);
...
// Teks tambahan di pinggir (rata kiri)
console.log(chalk.yellowBright("\nWhatsApp : +6285609287244"));
console.log(chalk.blueBright("Telegram : t.me/GupongShop"));
console.log(chalk.redBright("Yutub    : youtube.com/@GupongShop"));
console.log(chalk.magentaBright.bold("\nThanks Sudah Menggunakan Baileys GupongOfficial"));
